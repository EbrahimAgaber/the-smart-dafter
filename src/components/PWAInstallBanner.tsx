...
export const PWAInstallBanner: React.FC<PWAInstallBannerProps> = ({
  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-r from-sky-950/80 via-slate-900 to-indigo-950/80 border-b border-sky-500/20 px-3 py-2 flex items-center justify-between text-xs text-slate-200">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {isInstallable && (
            <button
              onClick={install}
              className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-[11px] shadow-xs active:scale-95 transition-all"
            >
          ...
          {!isMobile && (
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-sky-300 font-semibold text-[11px] border border-slate-700 transition-all"
            >
      ...
      {showIOSGuide && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="w-full max-w-sm bg-slate-900 rounded-3xl border border-slate-800 p-5 space-y-4 shadow-2xl">
